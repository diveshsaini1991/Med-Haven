      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-gray-700 dark:text-gray-200 mb-8">
          ...
          <div className="footer-section">
            <h4 className="font-semibold text-blue-700 dark:text-blue-400 mb-4 text-lg">Quick Links</h4>
          ...
          <div className="footer-section">
            <h4 className="font-semibold text-blue-700 dark:text-blue-400 mb-4 text-lg">Hours</h4>
            <ul className="space-y-2">
              {hours.map((element) => (
                <li key={element.id} className="flex justify-between text-sm">
                  <span>{element.day}</span>
                  <span className="text-gray-500 dark:text-gray-400">{element.time}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="footer-section">
            <h4 className="font-semibold text-blue-700 dark:text-blue-400 mb-4 text-lg">Contact</h4>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-sm text-gray-500 dark:text-gray-400">
          <span>© {new Date().getFullYear()} MedHaven. All rights reserved.</span>
          <span>
            Crafted with <span className="text-blue-500">❤️</span> by Divesh Saini
          </span>
        </div>
      </div>
    </footer>
